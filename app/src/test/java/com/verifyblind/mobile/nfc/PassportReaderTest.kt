 ...
 * DG1/DG2/SOD parsing testleri için sentetik ICAO TLV binary verisi gerekir; gerçek kart
 * dump'ları kişisel veri içerdiğinden test verisi olarak kullanılmaz.
 *
 * Kapsam:
