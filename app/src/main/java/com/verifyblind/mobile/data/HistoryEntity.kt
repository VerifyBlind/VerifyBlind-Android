...
data class HistoryEntity(
    ...
    // İşlemi yapan cihazın pazarlama adı (ör. "Google Pixel 7"). title/description gibi SecureContent
    // (AES-GCM + RSA) ile şifreli saklanır; okurken çözülür. Eski kayıtlarda boş.
