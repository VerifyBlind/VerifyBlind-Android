...
class FaceEmbedder(val context: Context) {
    ...
    init {
        try {
            ...
            AppLog.error("Yüz modeli yüklenemedi: ${e.message}", "FaceEmbedder", e)
        }
    }
    ...
    fun getEmbedding(bitmap: Bitmap): FloatArray? {
        ...
        return try {
            ...
            AppLog.error("Embedding (fallback) başarısız", "FaceEmbedder", e)
            null
        }
    }
    ...
    fun getAlignedBitmap(
        ...
        return try {
            ...
            // Bilineer filtre + anti-alias: affine warp + küçültmede daha az aliasing/jaggy →
            // R50'ye giden 112×112 daha temiz. (Paint'siz drawBitmap filtresiz örnekler.)
            ...
            AppLog.warning("Hizalı bitmap oluşturulamadı, fallback'e geçiliyor", "FaceEmbedder", e)
    ...
    private fun runInference(bitmap112: Bitmap): FloatArray? {
        return try {
            ...
            AppLog.error("Embedding inference başarısız", "FaceEmbedder", e)
            null
        }
    }
